...
try:
    ...
    from Chemformer.molbart.models.util import (
        PreNormEncoderLayer,
        PreNormDecoderLayer,
        FuncLR
    )
...
class _AbsTransformerModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_token_acc", token_acc, on_step=True, logger=True, sync_dist=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_token_acc", token_acc, prog_bar=True, logger=True, sync_dist=True)
        self.log("val_perplexity", perplexity, prog_bar=True, logger=True, sync_dist=True)
        self.log("val_molecular_accuracy", mol_acc, prog_bar=True, logger=True, sync_dist=True)
        self.log("val_invalid_smiles", invalid, prog_bar=True, logger=True, sync_dist=True)
